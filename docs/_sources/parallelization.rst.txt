Information: Automated parallelization
======================================
...
Also, many libraries such as *NumPy* release the GIL in many of their functions, so that they do run concurrently, when using threads.
